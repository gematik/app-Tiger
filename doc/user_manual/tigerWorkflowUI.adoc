...
image::screenshots/mismatch_notes_dropbox.png[title="Select Mismatch Dropdown Box"]
...
image::screenshots/mismatch_notes_down_button.png[title="Down Button"]
image::screenshots/mismatch_notes_up_button.png[title="Up Button"]
image::screenshots/mismatch_notes_dropdown.png[title="Expanded Mismatch Notes"]
image::screenshots/mismatch_notes_third_option.png[title="Selected Mismatch Note"]
...
If the Workflow UI is started without automatic execution of tests (see xref:_runTestsOnStart[Postpone start of test scenarios]), the Test Selector modal window will open automatically in the Workflow UI.
...
image::screenshots/testselector_modal.png[title="Test Selector modal window opened in the Workflow UI"]
...
image::screenshots/testselector_tags.png[title="Select tests by tags"]
...
image::screenshots/testselector_tags_dropdown.png[title="Submenu for tag selection with option for unselect and replace selection"]
...
image::screenshots/testselector_searchfields.png[title="Search fields in the Test Selector table"]

It is possible to save the current selection of tests in a file, which can be loaded later on.

image::screenshots/testselector_save_load.png[title="Save and load buttons for test selections"]

This may be useful for collaboration with other team members or for reusing the same selection in future test runs.

CAUTION: Cucumber discovers and identifies tests partially based on the feature file location and the line number where the tests are located.
...
image::screenshots/testselector_run_button.png[title="Run selected tests button"]
