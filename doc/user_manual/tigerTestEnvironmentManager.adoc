...
Here is a little example how the server keys are set and used and how there server is reachable via the Tiger Proxy.

[source,yaml,title="Example with there servers"]
----
servers:
  # here the servers key is "identityServer" and
  ...
  # here the servers key is "shoppingServer"
...
tigerProxy:
  ...
  tls:
    ...
    # the one defined here. This configures the server-side of the proxy.
    serverSslSuites:
      - "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"
    # This configures the SSL-Suites for the client-side
    clientSslSuites:
      - "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA"
