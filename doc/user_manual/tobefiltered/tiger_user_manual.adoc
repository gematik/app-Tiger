...
* *Hide details*  … collapses all the detailed information of the requests and responses.
* *Input field*  … allows you to filter the incoming messages with a RbelPath or a JEXL expression by using the "Set filter" button.
