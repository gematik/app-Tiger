...
[plantuml, "media/tigerOnly-file-structure", "svg", title="File structure of TigerOnly example project"]
----
@startwbs
...
* Main class: de.gematik.test.tiger.TigerCucumberRunner
* Glue:
...
* Program arguments:
    ** --plugin de.gematik.test.tiger.TigerCucumberListener
