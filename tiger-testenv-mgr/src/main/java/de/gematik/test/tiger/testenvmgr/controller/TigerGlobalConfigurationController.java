...
public class TigerGlobalConfigurationController {
    ...
    public List<TigerConfigurationPropertyDto> getGlobalConfiguration() {
        return TigerGlobalConfiguration.exportConfiguration().entrySet()
                .stream()
                .map(e -> TigerConfigurationPropertyDto.of(e.getKey(),
                        e.getValue().getRight(),
                        e.getValue().getLeft().toString()))
    ...
    public void updateConfiguration(@RequestBody TigerConfigurationPropertyDto propertyToUpdate) {
        boolean exists = TigerGlobalConfiguration.readStringOptional(propertyToUpdate.getKey()).isPresent();
    ...
    public void deleteConfiguration(@RequestBody TigerConfigurationPropertyDto propertyToDelete) {
        TigerGlobalConfiguration.deleteFromAllSources(new TigerConfigurationKey(propertyToDelete.getKey()));
    }
}
