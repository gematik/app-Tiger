...
class XDynamicSidebarTests extends AbstractBase {
    ...
    void ServerBoxAllServerRunning() {
        ...
        for (Locator server :
            ...
            assertThat(server).containsText(new String[]{"local_tiger_proxy", "httpbin", "remoteTigerProxy"});
        }
    }
    ...
    void testExecutionPaneScenariosExists() {
        assertAll(
            ...
            () -> Assertions.assertThat(page.locator(".test-execution-pane-scenario-title").count()).isPositive(),
            () ->
