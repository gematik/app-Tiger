...
class XYDynamicRbelLogTests extends AbstractBase {
    ...
    void testDRbelLogPaneHideDetailsButton() {
        ...
        assertThat(
            page.frameLocator("#rbellog-details-iframe")
                .locator(".test-card-content.d-none")).hasCount(20);
        page.frameLocator("#rbellog-details-iframe").locator("#dropdown-hide-button").click();
        assertThat(
            page.frameLocator("#rbellog-details-iframe")
    ...
    void testERbelLogPaneHideHeaderButton() {
        ...
        assertThat(
            page.frameLocator("#rbellog-details-iframe")
                .locator(".test-msg-header-content.d-none")).hasCount(20);
        assertThat(
            page.frameLocator("#rbellog-details-iframe")
                .locator(".test-msg-body-content.d-none")).hasCount(0);
        page.frameLocator("#rbellog-details-iframe").locator("#dropdown-hide-button").click();
        assertThat(
            page.frameLocator("#rbellog-details-iframe")
    ...
    void testFilterModalSetFilter() {
        ...
        page.frameLocator("#rbellog-details-iframe").locator("#filterModalButtonClose").click();
        assertThat(page.frameLocator("#rbellog-details-iframe").locator("#filteredMessage")).containsText(
            "4 of %d did match the filter criteria.".formatted(TOTAL_MESSAGES));
    }
    ...
    void testGSaveModal() {
        ...
        assertAll(
            ...
            () ->
                assertThat(
                    page.frameLocator("#rbellog-details-iframe")
                        .locator("#saveModalDialog .box")).not().isEmpty());

        page.frameLocator("#rbellog-details-iframe").locator("#saveModalButtonClose").click();
        assertThat(page.frameLocator("#rbellog-details-iframe").locator("#saveModalDialog")).not().isVisible();
    }
