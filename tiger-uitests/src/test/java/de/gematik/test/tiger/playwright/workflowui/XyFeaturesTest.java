...
class XyFeaturesTest extends AbstractBase {
  ...
  @CsvSource(
      ...
      textBlock =
          """
                ...
                Request for testing tooltips            | 26 | 0 |
                """)
  ...
  void testWhetherTitleContainsOriginal() {
    page.querySelector("#test-execution-pane-tab").click();
    Locator lastTd = page.locator(".test-execution-pane-scenario-title:last-of-type td:nth-of-type(2)");
    String title = lastTd.getAttribute("title");
    System.out.println("Title des letzten td: " + title);
