 ...
 */
package de.gematik.test.tiger.playwright.workflowui.replay;
...
class XDynamicPlaySidebarTest extends AbstractBase {
  ...
  void testRunAScenarioThenAbortInSidebar() {
    ...
    await()
        ...
        .untilAsserted(() -> assertNotNull(page.querySelector("#test-no-cancel")));
  ...
  void testRunAScenarioThenCommitInASidebar() {
    ...
    await()
        .atMost(10, TimeUnit.SECONDS)
        .untilAsserted(() -> assertNotNull(page.querySelector("#test-yes-play")));
    page.querySelector("#test-yes-play").click();
    await()
        .atMost(10, TimeUnit.SECONDS)
        .untilAsserted(() -> assertNull(page.querySelector("#test-yes-play")));
    ...
    assertAll(
        ...
        () ->
            assertThat(
                ...
                .hasCount(1),
        () -> assertThat(page.locator(".test-play-button")).hasCount(0),
        () -> assertThat(page.locator(".test-play-small-button")).hasCount(0),
        () ->
            assertThat(
                    page.locator(".test-execution-pane-feature-title")
                        .locator(".test-feature-status-word"))
