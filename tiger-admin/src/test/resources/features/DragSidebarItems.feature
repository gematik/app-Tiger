...
Feature: Check sidebar drag n drop of nodes
  ...
  Scenario: Drag first below last sidebar item
    ...
    And formulars are ordered "local_proxy,compose_001,tigerProxy_001,externalJar_001,docker_001"
  ...
  # Scenario: Drag first to below second
    ...
    And formulars are ordered "local_proxy,tigerProxy_001,compose_001,externalJar_001,docker_001"
  ...
  # Scenario: Drag third above second
    ...
    # When he drags sidebar item "compose_001" above "local_proxy"
    # Then nodes are ordered "Local Tiger proxy,compose_001,docker_001,tigerProxy_001,externalJar_001"
    # And formulars are ordered "local_proxy,compose_001,docker_001,tigerProxy_001,externalJar_001"

    # Scenario: Unable to drag local proxy
    When he tries to drag sidebar item "local_proxy" below "compose_001"
    Then nodes are ordered "Local Tiger proxy,docker_001,tigerProxy_001,compose_001,externalJar_001"
    And formulars are ordered "local_proxy,docker_001,tigerProxy_001,compose_001,externalJar_001"
