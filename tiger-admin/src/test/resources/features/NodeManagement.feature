...
Feature: Node management
  ...
  Scenario: add and delete server nodes
    ...
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,tigerProxy_001,externalJar_001,externalUrl_001"
  ...
  Scenario: add server type twice and check index in server key is increased
    ...
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001"
    ...
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,compose_002,compose_003"
  ...
  Scenario: rename node
    ...
    And formulars are ordered "local_tiger_proxy,docker_001,compose_222"
  ...
  Scenario: rename node with spaces
    ...
    And formulars are ordered "local_tiger_proxy,co_mpose_222"
  ...
  Scenario: rename node with invalid characters
    ...
    And formulars are ordered "local_tiger_proxy,docker_001"
    When he focuses on formular "docker_001"
    And he renames the node to "do:cker_222"
    Then nodes are ordered "Local Tiger proxy,docker_001"
    And formulars are ordered "local_tiger_proxy,do:cker_222"
    ...
    Then nodes are ordered "Local Tiger proxy,docker_001"
    And formulars are ordered "local_tiger_proxy,döckär_222"
    And he sees snack starting with "Only ASCII characters, digits and underscore allowed"
    And he closes open snack
    When he enters "docker_666" as new name for the node
    Then nodes are ordered "Local Tiger proxy,docker_001"
    And formulars are ordered "local_tiger_proxy,docker_666"
  ...
  Scenario: duplicate node simple increment
    ...
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,docker_002"
    When he duplicates node "docker_001"
    Then nodes are ordered "Local Tiger proxy,docker_001,compose_001,docker_002,docker_003"
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,docker_002,docker_003"
  ...
  Scenario: duplicate node no dash
    ...
    And formulars are ordered "local_tiger_proxy,docker,compose_001"
    ...
    And formulars are ordered "local_tiger_proxy,docker,compose_001,docker_001"
    When he duplicates node "docker_001"
    Then nodes are ordered "Local Tiger proxy,docker,compose_001,docker_001,docker_002"
    And formulars are ordered "local_tiger_proxy,docker,compose_001,docker_001,docker_002"
  ...
  Scenario: duplicate node already existing in between
    ...
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,dockerA_002,docker_003"
    When he duplicates node "docker_001"
    Then nodes are ordered "Local Tiger proxy,docker_001,compose_001,dockerA_002,docker_003,docker_002"
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,dockerA_002,docker_003,docker_002"


  Scenario: duplicate node check field value gets duplicated
    Given Gerriet is on the homepage
    When he adds a "docker" node via welcome screen
    And he adds a "compose" node via sidebar
    Then nodes are ordered "Local Tiger proxy,docker_001,compose_001"
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001"
    When he focuses on formular "docker_001"
    And he enters "source/dockerimage" into field "source"
    And he duplicates node "docker_001"
    Then nodes are ordered "Local Tiger proxy,docker_001,compose_001,docker_002"
    And formulars are ordered "local_tiger_proxy,docker_001,compose_001,docker_002"
    When he focuses on formular "docker_002"
    Then he checks field "source" contains "source/dockerimage"
