  ...
  void testMultipleViolations_shouldAllBeReportedInException() {
    ...
    var schema =
        """
        {
          ...
          "additionalProperties": false,
          "properties": {
            "username": { "type": "string", "const": "example" },
            "kimVersion": { "type": "string", "const": "1.5+" },
            "regStat": { "type": "string", "const": "registered" },
            "maxMailSize": { "type": "integer", "const": 734003200 },
            "dataTimeToLive": { "type": "integer", "minimum": 10, "maximum": 15 }
          }
        }
        """;
    assertThatExceptionOfType(JsonSchemaChecker.JsonSchemaAssertionError.class)
        .isThrownBy(() -> new JsonSchemaChecker().compareJsonToSchema(invalidJson, schema))
