...
class RbelContentTreeConverterTest {
    ...
    void simpleXml_ShouldGiveContentTree() {
        ...
        RbelWriter writer = new RbelWriter();
    ...
    void tgrIfTagInXml_shouldOnlyRenderCorrectNode() {
        ...
        XmlAssert.assertThat(new String(new RbelWriter().serialize(input)))
            .and("<?xml version=\"1.0\"?>\n"
                + "<rootNode>\n"
    ...
    void writeJson() {
        ...
        final String result = new String(new RbelWriter().serialize(input));
    ...
    void forLoopWithComplexIterable() {
        ...
        final String output = new String(new RbelWriter().serialize(input));
        System.out.println("\n\n\n" + output);
