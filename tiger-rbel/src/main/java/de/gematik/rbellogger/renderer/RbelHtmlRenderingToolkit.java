                        ...
                        section().withClass("main-content").with(
                            section().withClass("row header").with(
                                ...
                                div().withClass("col is-size-6")
                                    .with(
                                        div().withClass("row my-auto").with(
                                            div(rbelHtmlRenderer.getTitle()).withClass("col navbar-title is-size-3 h-100 my-auto"),
                                            span(rbelHtmlRenderer.getVersionInfo()).withClass("col-2 is-size-7 navbar-version")
                                        ),
