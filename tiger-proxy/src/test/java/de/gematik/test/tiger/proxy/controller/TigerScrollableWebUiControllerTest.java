...
@NotThreadSafe
@WireMockTest
class TigerScrollableWebUiControllerTest {
  ...
  public String getWebUiUrl() {
    log.info("Connecting to {}", "http://localhost:" + adminPort + "/nextwebui");
    return "http://localhost:" + adminPort + "/nextwebui";
  }

  @Test
  @ResourceLock(value = "TigerScrollableWebUiController")
