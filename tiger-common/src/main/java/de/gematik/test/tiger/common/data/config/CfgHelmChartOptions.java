...
public class CfgHelmChartOptions {
  ...
  /**
   * comma separated list of port forwardings Entries can be either "podNameRegex:xxxx", which is
   * shorthand for "podNameRegex:xxxx:xxxx or "podNameRegex:xxxx:yyyy" where xxxx is the local port
