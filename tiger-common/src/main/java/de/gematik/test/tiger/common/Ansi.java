...
public final class Ansi {
    ...
    public final static String SCHWARZEN = BLACK;
    public final static String RED = "\u001B[31m";
    public final static String ROTEN = RED;
    public final static String GREEN = "\u001B[32m";
    public final static String GRÜNEN = GREEN;
    public final static String YELLOW = "\u001B[93m";
    public final static String GELBEN = YELLOW;
    public final static String BLUE = "\u001B[96m";
    public final static String BLAUEN = BLUE;
    public final static String MAGENTA = "\u001B[35m";
    public final static String ROSA = MAGENTA;
    public final static String CYAN = "\u001B[36m";
    public final static String TÜRKISEN = CYAN;
    public final static String WHITE = "\u001B[37m";
    public final static String WEISSEN = WHITE;
