    ...
    private MessageMetaDataDto getMetaData(RbelElement el) {
        ...
        if (el.hasFacet(RbelHttpRequestFacet.class)) {
            ...
            b = b.path(req.getPath().getRawStringContent())
                    ...
                    .recipient(el.getFacetOrFail(RbelTcpIpMessageFacet.class).getReceiverHostname().toString());
            ...
            b.status(el.getFacetOrFail(RbelHttpResponseFacet.class).getResponseCode().seekValue(Integer.class).get())
                    .sender(el.getFacetOrFail(RbelTcpIpMessageFacet.class).getSenderHostname().toString());
        } else {
