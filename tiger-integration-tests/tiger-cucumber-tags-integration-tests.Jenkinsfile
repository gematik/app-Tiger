...
def REPO_URL = createGitUrl('git/Testtools/tiger/tiger-cucumber-tags-integration-test')
...
pipeline {
    ...
    stages {
        ...
        stage('Set Tiger version in Tiger cucumber tags integration test') {
            steps {
        ...
        stage('Run test script') {
            steps {
                script {
                    sh """
                    chmod +x runMultipleProfiles.sh 
                    ./runMultipleProfiles.sh
                    """
