...
import static de.gematik.test.tiger.mockserver.socket.tls.KeyAndCertificateFactoryFactory.createKeyAndCertificateFactory;
import static de.gematik.test.tiger.mockserver.socket.tls.PEMToFile.privateKeyFromPEMFile;
import static de.gematik.test.tiger.mockserver.socket.tls.PEMToFile.x509ChainFromPEMFile;
